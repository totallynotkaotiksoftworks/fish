...
-- Clean up old tracers periodically
task.spawn(function()
    while true do
        task.wait(10)
...
function BulletInterface.newBullet(Data)
    if Data.ontouch and Data.extra then
        ...
        local OriginalVelocity = Data.velocity -- Store original velocity
        ...
        if Controller and Weapon then
            ...
            -- Store whether we're using silent aim for tracer calculation
            ...
            if SETTINGS.SilentAim.Enabled and not Data.im_hacking then
                ...
                then
                    ...
                    if HitPart then
                        ...
                        -- Store silent aim info for tracer
            ...
            if SETTINGS.BulletTracers.Local.Enabled then
                ...
                -- Apply third person muzzle position if enabled
...
Reciever:Connect(function(Method, ...)
    if Method == 'newbullets' then
        ...
        then
            ...
            for Index, Bullet in next, BulletData.bullets do
                -- Proper raycast with RaycastParams
                local RayResult = workspace:Raycast(
                    FirePosition,
